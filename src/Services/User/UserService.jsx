...
const API_URL = 'https://apiduvas1.runasp.net/api/Users';
...
const UserService = {
    ...
    deposit: (amount) => {
        ...
        return axios.post('https://apiduvas1.runasp.net/api/Transaction', { "amount": amount }, {
            headers: {
    ...
    checkTransactionStatus: (description) => {
        const token = localStorage.getItem("authToken");
        return axios.get('https://apiduvas1.runasp.net/api/Transaction?description=' + description, {
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
            },
    ...
    getBankAccounts: () => {
        const token = localStorage.getItem("authToken");
        return axios.get('https://apiduvas1.runasp.net/api/UserProfile/BankAccount', {
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
            },
    ...
    genOtp: () => {
        const token = localStorage.getItem("authToken");
        return axios.get('https://apiduvas1.runasp.net/api/UserProfile/otp', {
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
            },
    ...
    addNewBank: (data, otp) => {
        const token = localStorage.getItem("authToken");
        return axios.post('https://apiduvas1.runasp.net/api/UserProfile/BankAccount?otp=' + otp, data, {
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
            },
    ...
    getTransactions: () => {
        const token = localStorage.getItem("authToken");
        return axios.get('https://apiduvas1.runasp.net/api/Transaction/GetTransactions', {
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "application/json",
            },
    ...
    withdraw: async (amount, bankAccountId) => {
        try {
            ...
            const response = await axios.post(
                'https://apiduvas1.runasp.net/api/Withdraw',
                {
    ...
    updateBankAccountStatus: (bankAccountId, active, otp = "0") => {
        const token = localStorage.getItem("authToken");
        const url = `https://apiduvas1.runasp.net/api/UserProfile/BankAccount`;
    ...
    getCurrentUserWithdrawRequest: () => {
        const token = localStorage.getItem("authToken");
        const url = `https://apiduvas1.runasp.net/api/WithDraw/user`;
