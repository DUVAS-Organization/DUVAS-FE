...
const Footer = () => {
    return (
        <footer className="bg-gray-100 shadow-md dark:bg-gray-800 border-t">
            <div className="container mx-auto max-w-6xl px-6 py-8 ">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-b pb-8 items-stretch ">
                    ...
                    <div className="flex flex-col  justify-center text-center md:text-left ">
                        <h2 className="text-lg font-medium text-gray-800 mb-2 dark:text-white">
                            Giới thiệu DUVAS
                        </h2>
                    ...
                    <div className="flex flex-col mt-5 text-center md:text-left ">
                        <h2 className="text-lg font-medium text-gray-800 mb-2 dark:text-white">Liên hệ</h2>
