...
const Searchbar = (props) => {
    ...
    const handleSearch = async () => {
        ...
        if (activeTab === "rooms") {
            ...
            let url = new URL("https://apiduvas1.runasp.net/api/Rooms/search-rooms");
            ...
            try {
                const response = await fetch(`http://apiduvas1.runasp.net/api/search-services?${queryParams.toString()}`, {
                    method: "POST",
                    headers: {
    ...
    const handleFileChange = async () => {
        ...
        try {
            const response = await fetch(`https://apiduvas1.runasp.net/api/SpeechToText/convert`, {
                method: "POST",
                body: formData,
            });
            const data = await response.json();
